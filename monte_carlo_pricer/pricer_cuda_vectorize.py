...
import numbapro
from numbapro import cuda, jit, vectorize
from numbapro.cudalib import curand
from cuda_helper import MM


@vectorize(['f8(f8, f8, f8, f8, f8)'], target='gpu')
def cu_monte_carlo_pricer(last, dt, c0, c1, noise):
...
def monte_carlo_pricer(paths, dt, interest, volatility):
    ...
    for j in range(1, paths.shape[1]):
        ...
        cu_monte_carlo_pricer(d_last, dt, c0, c1, d_normdist,
                              out=d_paths, stream=stream)
